...
public class MeasurementValidationTest {
    ...
    public void testMeasurement2() throws Exception {
        Measurement measurement = MeasurementFixture.getMeasurement2();
    ...
    public void testMeasurement3() throws Exception {
        Measurement measurement = MeasurementFixture.getMeasurement3();
    ...
    public void testSensor() throws Exception {
        ...
        measurement = MeasurementFixture.getMeasurement2();
    ...
    public void testValue() throws Exception {
        ...
        measurement = MeasurementFixture.getMeasurement3();
        measurement.setValue(1001.0f);
