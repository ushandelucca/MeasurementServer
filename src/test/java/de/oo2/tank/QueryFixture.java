...
public class QueryFixture {
    ...
    static {
        ...
        QUERY_MAP_1 = new MultivaluedHashMap<String, String>();
        ...
        QUERY_MAP_2 = new MultivaluedHashMap<String, String>();
